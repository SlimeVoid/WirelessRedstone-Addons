...
public class PrivatizerCore {
    ...
    public static void initialize() {
        EtherPrivatizer.proxy.init();

        EtherPrivatizer.proxy.addOverrides();

        EtherPrivatizer.proxy.registerRenderInformation();
    }
    ...
    private static void registerItems() {
        itemRemote = (new ItemEtherPrivatizer(remoteID)).setUnlocalizedName(ItemLib.REMOTE);
