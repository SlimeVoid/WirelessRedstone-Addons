...
import net.slimevoid.wirelessredstone.addon.camouflager.core.lib.CamouAddonData;
import net.slimevoid.wirelessredstone.addon.camouflager.core.lib.CamouLib;
import net.slimevoid.wirelessredstone.addon.camouflager.core.lib.CoreLib;
