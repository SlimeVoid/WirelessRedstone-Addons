 ...
 */
package net.slimevoid.wirelessredstone.addon.camouflager.client.proxy;

import net.minecraft.client.Minecraft;
import net.minecraft.entity.player.EntityPlayer;
import net.minecraft.tileentity.TileEntity;
import net.minecraft.world.World;
import net.slimevoid.wirelessredstone.addon.camouflager.client.presentation.BlockWirelessCamouRenderer;
import net.slimevoid.wirelessredstone.addon.camouflager.client.presentation.gui.GuiRedstoneWirelessCamouflager;
import net.slimevoid.wirelessredstone.addon.camouflager.inventory.ContainerCamouflagedRedstoneWireless;
import net.slimevoid.wirelessredstone.addon.camouflager.proxy.CamouCommonProxy;
