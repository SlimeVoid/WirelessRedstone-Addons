 ...
 */
package net.slimevoid.wirelessredstone.addon.camouflager.client.presentation.gui;

import net.minecraft.client.gui.GuiButton;
import net.minecraft.util.ResourceLocation;
import net.slimevoid.wirelessredstone.addon.camouflager.core.lib.GuiLib;
